...
App.xaml.cs (Application)
  └── MainWindow (NavigationView)
        ...
        └── AccountPage → AuthService (Firebase Email/Password + PasswordVault) + UpdateChecker (simulado)
```
